...
public enum MemberPermission {
    ...
    ADMIN_DEFAULT(ADMIN, MEMBER_DEFAULT, PIN_MESSAGES, CHANGE_MEMBER_INFO, CLEAR_HISTORY, BAN_USERS, PROCESS_JOIN_REQUESTS, VIEW_AUDIT_LOGS, DELETE_MESSAGES, ADD_NEW_ADMINS, MANAGE_INVITE_LINKS, MANAGE_AVATARS),
    CHANNEL_DEFAULT(CREATE_INVITE_LINKS),
    PRIVATE_CHAT_DEFAULT(SEND_TEXT_MESSAGE, SEND_MEDIA, DELETE_MESSAGES, LIST_USERS, CLEAR_HISTORY);
