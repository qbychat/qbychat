...
public class CommandLineInterface {
    ...
    public void generateProfile() {
        ...
        try (FileOutputStream outputStream = new FileOutputStream(lang)) {
    ...
    public void detectLang() throws IOException {
        ...
        for (String filename : arglist) {
            try (BufferedReader is = new BufferedReader(new InputStreamReader(new FileInputStream(filename), StandardCharsets.UTF_8))) {
    ...
    public void batchTest() throws IOException {
        ...
        for (String filename : arglist) {
            ...
            for (String lang : langList) {
                ...
                System.out.printf("%s (%d/%d=%.2f): %s%n", lang, correct, count, rate, resultCount);
                totalCorrect += correct;
                totalCount += count;
            }
            System.out.printf("total: %d/%d = %.3f%n", totalCorrect, totalCount, totalCorrect / (double) totalCount);
        }
    }
