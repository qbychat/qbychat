...
public class TechnicalLanguageDetectorImplTest {
    ...
    public final void testDetector1() {
        ...
        assertEquals("en", languageDetector.detect("a").get().getLanguage());
    }

    @Test
    public final void testDetector2() {
        LanguageDetector languageDetector = makeDetector();
        assertEquals("fr", languageDetector.detect("b d").get().getLanguage());
    }

    @Test
    public final void testDetector3() {
        LanguageDetector languageDetector = makeDetector();
        assertEquals("en", languageDetector.detect("d e").get().getLanguage());
    }

    @Test
    public final void testDetector4() {
        LanguageDetector languageDetector = makeDetector();
        assertEquals("ja", languageDetector.detect("\u3042\u3042\u3042\u3042a").get().getLanguage());
    }
}
