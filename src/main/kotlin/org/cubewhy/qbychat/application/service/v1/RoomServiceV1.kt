...
import org.cubewhy.qbychat.rpc.room.v1.CreatePrivateRoomResponse
import org.cubewhy.qbychat.rpc.room.v1.SyncRequest
import org.cubewhy.qbychat.rpc.room.v1.SyncResponse

interface RoomServiceV1 {
    suspend fun sync(request: SyncRequest, user: User): SyncResponse
    suspend fun createPrivateRoom(request: CreatePrivateRoomRequest, user: User): CreatePrivateRoomResponse
}