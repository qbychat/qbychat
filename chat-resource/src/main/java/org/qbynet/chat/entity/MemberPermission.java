...
public enum MemberPermission {
    ...
    ADMIN_DEFAULT(MEMBER_DEFAULT, PIN_MESSAGES, CHANGE_MEMBER_INFO, BAN_USERS, APPROVE_JOIN_REQUESTS, DELETE_MESSAGES, ADD_NEW_ADMINS, MANAGE_INVITE_LINKS, MANAGE_AVATARS),
